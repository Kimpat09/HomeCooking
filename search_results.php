...
<div class="container">
    ...
    <?php
        ...
        $sql = mysql_query("SELECT * FROM recipe WHERE name LIKE '%". mysql_real_escape_string($search)."%' or description LIKE '%". mysql_real_escape_string($search)."%' or ingredients LIKE '%". mysql_real_escape_string($search)."%' or origin LIKE '%". mysql_real_escape_string($search)."%'");
